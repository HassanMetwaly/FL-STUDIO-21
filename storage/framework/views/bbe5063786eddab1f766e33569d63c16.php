...
<body dir="rtl">
    <nav class="navbar fixed-top shadow mb-4 bg-body-tertiary">
        <div class="container">
            ...
            <img class="border border-dark rounded-5 mx-1" height="45px" width="45px" src="<?php echo e(asset('images')); ?>/logo.JPG" alt="Logo" width="30" height="24" class="d-inline-block align-text-top">
