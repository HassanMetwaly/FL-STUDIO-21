                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-3 col-xl-3 mb-4 mb-lg-0">
                                    <div class="custom-button rounded">
                                        <img width="280px" height="200px" src="<?php echo e(asset('images')); ?>/<?php echo e($product->image); ?>"
                                            class="w-100 h-100" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-3 col-xl-3 border-sm-start-none border-start">
                                    ...
                                    <h6 class="<?php echo \Illuminate\Support\Arr::toCssClasses(["pt-1 text-success" , $product->is_done ? 'text-danger' : '']); ?>">
                                        <?php if($product->is_done): ?>
                                            الكمية متوفرة
                                        <?php else: ?>
                                            تم نفاذ الكمية
                                        <?php endif; ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Windows\online-shop-app\resources\views/products.blade.php ENDPATH**/ ?>